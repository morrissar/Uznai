...
MY_AND_VLD_GROUP_ID = -5110891980
...
async def process_any_post(message: Message, state: FSMContext, bot: Bot):
    ...
    if message.text:
        ...
        post_msg_admin = await bot.send_message(
        ...
        post_msg_admin = await bot.send_photo(
            chat_id=ADMIN_GROUP_ID, 
            message_thread_id=2, 
        ...
        post_msg_admin = await bot.send_photo(
            ...
            message_thread_id=2, 
            photo=message.photo[-1].file_id, 
            caption="<a href='https://t.me/yznay138'>Узнай за УИ</a>", 
            parse_mode='HTML'
        )
    elif message.video and message.caption:
        new_caption = message.caption + "\n\n<a href='https://t.me/yznay138'>Узнай за УИ</a>"
        post_msg_admin = await bot.send_video(
            chat_id=ADMIN_GROUP_ID, 
            message_thread_id=2, 
        ...
        post_msg_admin = await bot.copy_message(
            chat_id=ADMIN_GROUP_ID, 
